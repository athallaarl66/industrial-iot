              ...
              <div className="mt-10 pt-8 border-t border-slate-100">
                <div className="p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                   ...
                   <p className="text-[10px] text-slate-500 leading-normal font-medium italic">
                     Nodes must adhere to <strong>ID-LOCATION-SERIAL</strong> schema for automated telemetry ingestion.
                   </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between px-2">
                <div className="flex items-center space-x-3">
                  <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight italic">Inventory Registry</h3>
                  <span className="text-[10px] font-bold text-slate-300 uppercase tracking-tighter">Read/Write Access</span>
                </div>
                <button 
              ...
              <div className="industrial-panel overflow-hidden border-slate-100">
