      ...
      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
        <div className="flex justify-end">
           <button
             ...
             className="group/btn flex items-center justify-end gap-2 px-3 py-2 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-all overflow-hidden w-10 hover:w-28"
             title="Decommission Node"
           >
             <span className="text-[10px] uppercase font-black tracking-widest opacity-0 group-hover/btn:opacity-100 transition-opacity whitespace-nowrap">Revoke</span>
